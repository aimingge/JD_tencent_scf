...
* > 【青龙】拉取仓库命令：`ql repo https://github.com/aimingge/JD_tencent_scf.git "jd_|jx_|getJDCookie"  "backUp|icon" "^jd[^_]|USER|sendNotify|sign_graphics_validate|JDJR|JDSign" "main"`
